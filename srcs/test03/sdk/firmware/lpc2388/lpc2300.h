...
#define	IMPORT_BIN(file, sym) __asm (\
		".section \".rodata\"\n"\
		".balign 4\n"\
		".global " #sym "\n"\
		#sym ":\n"\
...
#define	IMPORT_BIN_PART(file, ofs, siz, sym) __asm (\
		".section \".rodata\"\n"\
		".balign 4\n"\
		".global " #sym "\n"\
		#sym ":\n"\
...
// --------------- 追加1207ラインまで----------2011.10.26----------
struct	DB32						/*Bit Access*/
{
		...
		unsigned char B30:1;		/* Bit 20 */
		unsigned char B31:1;		/* Bit 31 */
} ;

struct	DB16						/*Bit Access*/
{
		unsigned char B0:1;			/* Bit 0 */
		unsigned char B1:1;			/* Bit 1 */
		unsigned char B2:1;			/* Bit 2 */
...
#define	  FIO0DIR_ADR	0x3FFFC000		
#define	  FIO1DIR_ADR	0x3FFFC020	
#define	  FIO2DIR_ADR	0x3FFFC040		
#define	  FIO3DIR_ADR	0x3FFFC060	
#define	  FIO4DIR_ADR	0x3FFFC080

#define	  FIO0PIN_ADR	0x3FFFC014		
#define	  FIO1PIN_ADR	0x3FFFC034	
#define	  FIO2PIN_ADR	0x3FFFC054		
#define	  FIO3PIN_ADR	0x3FFFC074	
#define	  FIO4PIN_ADR	0x3FFFC094	

#define	  FIO0SET_ADR	0x3FFFC018		
#define	  FIO1SET_ADR	0x3FFFC038	
#define	  FIO2SET_ADR	0x3FFFC058		
#define	  FIO3SET_ADR	0x3FFFC078	
#define	  FIO4SET_ADR	0x3FFFC098
	
#define	  FIO0CLR_ADR	0x3FFFC01C		
#define	  FIO1CLR_ADR	0x3FFFC03C	
#define	  FIO2CLR_ADR	0x3FFFC05C		
#define	  FIO3CLR_ADR	0x3FFFC07C	
#define	  FIO4CLR_ADR	0x3FFFC09C

#define	  FIO0DIR_B (*(volatile struct DB32 *)FIO0DIR_ADR)	
#define	  FIO1DIR_B (*(volatile struct DB32 *)FIO1DIR_ADR)	
#define	  FIO2DIR_B (*(volatile struct DB32 *)FIO2DIR_ADR)	
#define	  FIO3DIR_B (*(volatile struct DB32 *)FIO3DIR_ADR)	
#define	  FIO4DIR_B (*(volatile struct DB32 *)FIO4DIR_ADR)	

#define	  FIO0PIN_B (*(volatile struct DB32 *)FIO0PIN_ADR)	
#define	  FIO1PIN_B (*(volatile struct DB32 *)FIO1PIN_ADR)	
#define	  FIO2PIN_B (*(volatile struct DB32 *)FIO2PIN_ADR)	
#define	  FIO3PIN_B (*(volatile struct DB32 *)FIO3PIN_ADR)	
#define	  FIO4PIN_B (*(volatile struct DB32 *)FIO4PIN_ADR)	

#define	  FIO0SET_B (*(volatile struct DB32 *)FIO0SET_ADR)	
#define	  FIO1SET_B (*(volatile struct DB32 *)FIO1SET_ADR)	
#define	  FIO2SET_B (*(volatile struct DB32 *)FIO2SET_ADR)	
#define	  FIO3SET_B (*(volatile struct DB32 *)FIO3SET_ADR)	
#define	  FIO4SET_B (*(volatile struct DB32 *)FIO4SET_ADR)	

#define	  FIO0CLR_B (*(volatile struct DB32 *)FIO0CLR_ADR)	
#define	  FIO1CLR_B (*(volatile struct DB32 *)FIO1CLR_ADR)	
#define	  FIO2CLR_B (*(volatile struct DB32 *)FIO2CLR_ADR)	
#define	  FIO3CLR_B (*(volatile struct DB32 *)FIO3CLR_ADR)	
#define	  FIO4CLR_B (*(volatile struct DB32 *)FIO4CLR_ADR)	
